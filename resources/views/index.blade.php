...
<div class="container-fluid">
	<br>
	<h6 align="center" class="alert alert-info" style="border-radius: 0px; font-family: 'Sanchez', serif; color:black; font-size: 20px;">Contact Management: List of all the companies</h6>
</div>
