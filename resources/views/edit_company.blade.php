...
<div class="container col-md-6">
	...
	<div id="cardbody" class=" card" style="width: 34rem; background-color:white;">
		...
		<div id="" class="container-fluid col-sm-10" style="font-size:13px;">
                    ...
                    @endif
		<form method="POST" action="{{route('update_company',$edit_company_id->id) }}">
			@csrf
			<p></p>
		  ...
		  <div class="form-group ">
		    ...
		    <input type="text" class="form-control form-control-sm" name="name" value="{{$edit_company_id->name}}">
		  </div>
		  ...
		  <div class="form-group ">
		    ...
		    <input type="text" class="form-control form-control-sm" name="website" value="{{$edit_company_id->website}}">
		  </div>

		  <div class="form-group ">
		    <label for="exampleInputEmail1">Address</label>
		    <input type="text" class="form-control form-control-sm" name="address" value="{{$edit_company_id->address}}">
		  </div>
